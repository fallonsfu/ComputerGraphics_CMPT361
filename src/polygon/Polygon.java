...
public class Polygon extends Chain {
	...
	public void setFaceColor(Color faceColor) { this.faceColor = faceColor; }

	public double getkSpecular() { return kSpecular; }

	public double getSpecularExponent() { return specularExponent; }

	public void setSpecular(double kSpecular, double specularExponent) {
